...
public class Logger {
    ...
    public Object aroundPrintLog(ProceedingJoinPoint pjp){
        ...
        try {
            ...
            System.out.println("最终通知Logger类中的aroundPrintLog方法开始记录日志.......前置");
            pjp.proceed(args); //明确调用业务层方法(切入点)
            System.out.println("最终通知Logger类中的aroundPrintLog方法开始记录日志.......后置");
            return rtValue;
        } catch (Throwable throwable) {
            System.out.println("最终通知Logger类中的aroundPrintLog方法开始记录日志.......异常");
            throw new RuntimeException(throwable );
        }finally {
            System.out.println("最终通知Logger类中的aroundPrintLog方法开始记录日志.......最终");
        }
    }
